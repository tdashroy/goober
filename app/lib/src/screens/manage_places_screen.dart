...
/// Curating the group's places: add, edit, delete, and copy in last year's list.
///
/// This is an admin's screen, reached only from the admin area, so its controls
/// are always on — a member never lands here, and browses the read-only
/// [PlacesScreen] instead. The server enforces admin permission on every one of
/// these calls regardless of what the client chooses to show.
